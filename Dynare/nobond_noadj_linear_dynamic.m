...
residual = zeros(11, 1);
T48 = y(5)*params(2)/(1-params(14))^2;
...
residual(1)= lhs-rhs;
lhs =y(4);
rhs =(-(1-params(3)))*params(13)/params(14)*y(9)+(1-params(3))*(1-params(16))/y(6)*y(10)-y(6)*params(13)*(1-params(3))*(1-params(16))*params(14)^(-2);
residual(2)= lhs-rhs;
lhs =y(4);
rhs =y(5)*params(2)/(1-params(14))+y(6)*T48;
residual(3)= lhs-rhs;
...
if nargout >= 2,
  ...
  g1(1,7)=1;
  g1(2,4)=1;
  g1(2,6)=(-(y(10)*(-((1-params(3))*(1-params(16))))/(y(6)*y(6))-params(13)*(1-params(3))*(1-params(16))*params(14)^(-2)));
  g1(2,9)=(-((-(1-params(3)))*params(13)/params(14)));
  g1(2,10)=(-((1-params(3))*(1-params(16))/y(6)));
  g1(3,4)=1;
  g1(3,5)=(-(params(2)/(1-params(14))+y(6)*params(2)/(1-params(14))^2));
  g1(3,6)=(-T48);
